...
open class FloatRatingView: UIView {
    ...
    private func updateLocation(_ touch: UITouch) {
        ...
        if ["en","es","ja"].contains(appDelegate.language){//} == "en" || appDelegate.language == "es" ||  appDelegate.language == "ja" {
            from1 = maxRating-1
            through1 = 0
    ...
    override open func layoutSubviews() {
        ...
        for i in 0..<maxRating {
            ...
            if appDelegate.language == "en" || appDelegate.language == "es" ||  appDelegate.language == "ja"{
