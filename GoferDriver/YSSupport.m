...
#import "GoferDriver-Bridging-Header.h"
...
+(NSString *)getDeviceToken
{
    ...
    {
        return @"94c8a93426e12a874c8e9355da737a15db2f4a1da0d9c38de7340e8f66812b34"; // dummy device token
    }
    else
    {
...
//
//    [login logInWithReadPermissions: @[@"public_profile",@"email",@"user_location",@"user_birthday",@"user_hometown"] handler:^(FBSDKLoginManagerLoginResult *result, NSError *error)
//     {
//         if (error) {
//             NSLog(@"Process error");
...
//                 //                 SYNCHRONISE;
//                 
//                 NSLog(@"Token is available : %@",access_token);
//                 
//                 
//                 
//                 [[[FBSDKGraphRequest alloc] initWithGraphPath:@"me" parameters:@{ @"fields": @"id,picture,first_name, last_name, email, gender"} tokenString:access_token version:nil HTTPMethod:@"GET"]
...
//    
//    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@newsfeed/activity_update_read_status",iApp.APIBaseUrl]];
