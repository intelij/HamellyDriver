...
extension UILabel{
    ...
    func setText(_ fullText : String,withLinks links : [HyperLinkModel]){
        ...
        let attributes : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue) : highlight,
                                                           NSAttributedString.Key(rawValue: NSAttributedString.Key.underlineColor.rawValue) : highlight,
